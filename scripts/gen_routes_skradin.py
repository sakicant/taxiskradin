...
def build(frm, to, slug):
    ...
    if rev:
        ...
        # The Šibenik-origin reverse leg lives on the sister site taxisibenik.hr.
    ...
    if typ == "to_airport":
        ...
        intro = ("Flying out of %s? A taxi or private transfer from %s to %s is the simple, stress-free way to make your flight. "
                 "I am Antonio, a local driver, and I collect you at your door in %s and drive you straight to the departures terminal "
...
''' % (hero_img_html,
    ...
    schema = [
        {"@context": "https://schema.org", "@type": "Service",
         ...
         "provider": PROVIDER,
         "areaServed": [frm, to],
         "url": "https://taxiskradin.hr/%s/" % slug,
